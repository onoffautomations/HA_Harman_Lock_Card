class HartmanDoorLockCard extends HTMLElement {
  ...
  setConfig(config) {
    ...
    this._colorTheme = config.color_theme || 'purple'; // purple, blue, green
  }
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .pulse-grid-card {
            ...
            min-height: 80px;
            overflow: visible;
            ${this._purpleOutline ? `border: 2px solid ${theme.primary};` : ''}
          }
          ...
          .advanced-indicator {
            ...
            font-size: 8px;
            color: white;
            box-shadow: 0 1px 3px ${theme.primaryShadow};
          }
          ...
          .dialog-action-btn.pulse { background: ${theme.primary}; color: white; }
          .dialog-action-btn.pulse:hover:not(:disabled) { background: ${theme.primaryDark}; }
    ...
    this.shadowRoot.innerHTML = `
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .action-btn.pulse:hover:not(:disabled) { background: ${theme.primaryDark}; }
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="config-row">
        ...
        <select id="color_theme">
          <option value="purple" ${this._config?.color_theme === 'purple' || !this._config?.color_theme ? 'selected' : ''}>Purple</option>
...
console.info(
  '%c HARTMAN-DOOR-LOCK-CARD %c 1.2.1 ',
